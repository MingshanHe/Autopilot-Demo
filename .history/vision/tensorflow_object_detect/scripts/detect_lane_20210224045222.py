...
import time
from tensorflow_object_detect import Center
...
class DetectLane():
    ...
    def __init__(self):
        ...
        self.pub_center_white_lane  = rospy.Publisher('/control/white_lane', Center, queue_size = 1)
        self.pub_center_yellow_lane = rospy.Publisher('/control/yellow_lane', Center, queue_size = 1)
    ...
    def maskLane(self,image):
        ...
        # Publish Center
        self.pub_center_white_lane.publish([white_x,white_y])
