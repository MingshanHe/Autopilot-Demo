...
class DetectLane():
    ...
    def maskLane(self,image):
        ...
        white_center = contours_white[0].sum()/len(contours_white[0])
        ...
        yellow_center = contours_yellow[0].sum()/len(contours_yellow[0])
        ...
        # self.pub_center.publish((pos_white_x+pos_yellow_x)/2)
