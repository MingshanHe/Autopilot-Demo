...
class DL_Control():
    ...
    def __init__(self):
        ...
        self.sub_yellow_lane_center   = rospy.Subscriber('/control/center', Float64, self.cbFindCenterLane, queue_size = 1)
        self.pub_cmd_vel  = rospy.Publisher('/cmd_vel', Float64, queue_size = 1)
    ...
    def cbFindCenterLane(self, center_msg):
